...
export interface SMARTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
      | "allowance"
...
export interface SMARToken extends BaseContract {
  connect(runner?: ContractRunner | null): SMARToken;
  waitForDeployment(): Promise<this>;

  interface: SMARTokenInterface;
