...
export type { Auth } from "./contracts/access-control/Auth";
...
export type { SMARToken } from "./contracts/SMARToken";
export { SMARToken__factory } from "./factories/contracts/SMARToken__factory";
